...
api[0].list[0].list.push({
    order: '1',
    deprecated: 'false',
    url: 'http://localhost:8080/cache/cache',
    methodId: '2a485bbabcbd22690903873548c09c16',
    desc: '',
});
api[0].list.push({
...
api[0].list[1].list.push({
    order: '1',
    deprecated: 'false',
    url: 'http://localhost:8080/test/piublicV',
    methodId: '67f0d23172e9e2065c1195c96506ccb9',
    desc: '公开访问',
});
api[0].list[1].list.push({
    order: '2',
    deprecated: 'false',
    url: 'http://localhost:8080/test/privateV',
    methodId: '4b44b0630f4e1cacce4e37a1a50e405e',
    desc: '需要登录才能访问',
});
api[0].list[1].list.push({
    order: '3',
    ...
    methodId: '0e9ec23186e8b7d7882547af8fe5c7ad',
    desc: '个人详情',
});
api[0].list.push({
...
api[0].list[2].list.push({
    order: '1',
    deprecated: 'false',
    url: 'http://localhost:8080/file/upload/{classify}',
    methodId: 'f84ef50de99fd0a6d8463be1adbb2603',
    desc: '文件上传',
});
